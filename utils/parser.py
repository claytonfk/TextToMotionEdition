...
def add_data_options(parser):
    ...
    group.add_argument("--data_dir", default='./dataset/HumanML3D/', type=str,
...
def add_sampling_options(parser):
    ...
    group.add_argument("--model_path", default='./save/humanml_trans_enc_512/model000200000.pt', type=str,
...
def add_generate_options(parser):
    ...
    group.add_argument("--motion_length", default=6.0, type=float,
                       help="The length of the sampled motion [in seconds]. "
                            "Maximum is 9.8 for HumanML3D (text-to-motion)")
...
def add_edit_options(parser):
    ...
    group.add_argument("--prefix_end", default=0.4, type=float,
...
def generate_model_args(model_path):
    parser = ArgumentParser()
